...
* **QAOA Explained:** [Quantum Alternating Operator Ansatz](https://learning.quantum.ibm.com/course/fundamentals-of-quantum-algorithms/quantum-approximate-optimization-algorithm) - Details on the variational layer structure.
...
| **5**    | 15        | 5        | 3        | Geometric "Wedge" distributions.     |
...
![convergence_instance5.png](convergence_instance5.png)

### Route Mapping
Final routes are reconstructed as: `Depot → Client A → Client B → Depot`.

![map_instance5.png](map_instance5.png)
...
This metric allows us to benchmark exactly how much "Quantum Advantage" we are gaining (or how much noise we are fighting) compared to a perfectly solved classical baseline for each cluster.
